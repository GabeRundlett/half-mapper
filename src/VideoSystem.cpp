 ...
 */
VideoSystem::VideoSystem(int iWidth, int iHeight, float fFov, bool bFullscreen, bool bMultisampling, bool bVsync) : m_iWidth(iWidth), m_iHeight(iHeight), m_fFov(fFov), m_bFullscreen(bFullscreen), m_bMultisampling(bMultisampling), m_bVsync(bVsync) {
 ...
 */
void VideoSystem::SetupViewport() const {
