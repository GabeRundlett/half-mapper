...
class ConfigXML {
  public:
    ...
    // User config.
    unsigned int m_iWidth{800};             /** Window width. */
    unsigned int m_iHeight{600};            /** Window height. */
    float m_fFov{60.0f};                    /** Field of view angle. */
    bool m_bIsometric{false};               /** Isometric rendering. */
    bool m_bFullscreen{false};              /** Fullscreen or Windowed mode. */
    bool m_bMultisampling{false};           /** Enable or disable multisampling. */
